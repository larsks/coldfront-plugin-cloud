...
class TestAllocation(base.TestBase):
    ...
    def test_new_allocation_quota(self):
        ...
        self.assertEqual(allocation.get_attribute(attributes.QUOTA_LIMITS_STORAGE), 2 * 10)
        ...
        utils.set_attribute_on_allocation(allocation, attributes.QUOTA_LIMITS_STORAGE, 100)
        ...
        self.assertEqual(allocation.get_attribute(attributes.QUOTA_LIMITS_STORAGE), 100)
